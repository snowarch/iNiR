    ...
    Item {
        ...
        RowLayout {
            ...
            RippleButton {
                ...
                colRipple: !TimerService.stopwatchPaused
                ...
                contentItem: StyledText {
                    ...
                    color: !TimerService.stopwatchPaused
                        ? (Appearance.inirEverywhere ? Appearance.inir.colText
                            : Appearance.auroraEverywhere ? Appearance.colors.colOnLayer2 : Appearance.colors.colOnSecondaryContainer)
                        : Appearance.colors.colOnPrimary
                    text: !TimerService.stopwatchPaused ? Translation.tr("Pause") : TimerService.stopwatchTime === 0 ? Translation.tr("Start") : Translation.tr("Resume")
                }
            }
            ...
            RippleButton {
                ...
                onClicked: {
                    if (!TimerService.stopwatchPaused)
                ...
                contentItem: StyledText {
                    horizontalAlignment: Text.AlignHCenter
                    text: !TimerService.stopwatchPaused ? Translation.tr("Lap") : Translation.tr("Reset")
                    color: !TimerService.stopwatchPaused
