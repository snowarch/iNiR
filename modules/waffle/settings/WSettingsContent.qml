...
Item {
    ...
    property var searchIndex: [
        ...
        { pageIndex: 4, pageName: "Themes", section: "Cava Options", label: "Cava palette, response and apps", targetLabel: "Color source", keywords: ["cava", "visualizer", "spectrum", "audio", "source", "apps", "spotify", "ncspot", "ytmusic", "palette", "vibrant", "album", "cover", "sensitivity", "bars", "framerate", "stereo", "wave", "opacity", "reset"] },
